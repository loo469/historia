...
- côté carte, `buildCultureMapOverlay` transforme cultures, recherches et événements historiques en marqueurs régionaux stables avec score d'influence, tier visuel, highlights, `eventPopups` et un contrat visuel enrichi (`accent`, `labelTone`, `surface`, `glow`) pour mieux distinguer les zones culturelles et ouvrir les événements depuis la carte

...
- dans `web/app.js`, l'overlay économie expose un HUD logistique sombre avec glyphes de ressources, badges de stock par ville, manifeste des cargaisons par route, halos de tension, paquets de flux, pictogrammes de mode de transport, ticks de risque et légende compacte pour lire routes, hubs, capacités et pénuries dans le style Pax Historia sans surcharger la carte

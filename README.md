...
- dans `web/app.js`, l'overlay économie expose un HUD logistique sombre avec glyphes de ressources, badges de stock par ville, manifeste des cargaisons par route, halos de tension et légende compacte pour lire routes, hubs, capacités et pénuries dans le style Pax Historia sans surcharger la carte

            ...
            actionableAfter: {
              ...
              impactPreview: {
                ...
                deferConsequence: {
                  ...
                  deadlineCue: 'prochaine rotation culturelle',
                  lostBenefit: 'la revue reste non actionnable jusqu’à prochaine rotation culturelle',
                  summary: 'Si reporté: seuil encore fermé jusqu’à prochaine rotation culturelle; le bénéfice de revue actionnable est perdu ce tour.',
                },
                followUpAfterAction: {
                  state: 'review-unlocked-next',
                  label: 'Après action',
                  followUpType: 'review-unlocked',
                  watchCue: 'risque stabilisé par l’historique lisible',
                ...
                unlocksAfterFollowUp: {
                  ...
                  afterWindow: 'Suivi maintenant: lancer la revue débloquée tant que le seuil vient d’être franchi.',
                  nextCue: 'lancer la revue débloquée puis comparer avec risque stabilisé par l’historique lisible',
                  summary: 'Débloque ensuite: revue culturelle actionnable après la fenêtre prochaine rotation culturelle.',
                },
                nextReviewAfterUnlock: {
                  state: 'next-review-simplified',
                  label: 'Prochaine revue',
                  reviewEffect: 'simplified',
                  effectLabel: 'simplifiée',
                  reason: 'franchit le seuil avant prochaine rotation culturelle',
                  watchDebt: 'surveiller risque stabilisé par l’historique lisible',
                  afterWindow: 'Suivi maintenant: lancer la revue débloquée tant que le seuil vient d’être franchi.',
                  ...
                  summary: 'Prochaine revue simplifiée: revue culturelle actionnable; surveiller risque stabilisé par l’historique lisible.',
                },

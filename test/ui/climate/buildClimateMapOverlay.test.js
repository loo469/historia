        ...
        followUpQueue: [
          {
            ...
            cooldownReadiness: {
              ...
              label: 'encore risqué',
              availableInTurns: 3,
              linkedRiskDelta: 'worsening-probable',
              reason: 'catastrophe/risque régional résiduel',
              waitingAction: 'ne pas empiler: sécuriser réserve ou mitigation avant engagement',
            },
            readinessRecap: {
              state: 'still-risky',
              reason: 'catastrophe/risque régional résiduel',
              linkedCooldownState: 'still-risky',
              linkedRiskDelta: 'worsening-probable',
              residualRisk: 'résiduel élevé: catastrophe, mythe ou région fragile peut relancer l’alerte',
              safeAction: 'sécuriser ressource/mitigation puis relire le delta avant engagement',
              avoidAction: 'éviter tout empilement mitigation + réserve dans le même tour',
              dataConfidence: 'fragile',
            },
          },
        ],
      },
    ...
    followUpQueue: [
      {
        ...
        cooldownReadiness: {
          ...
          availableInTurns: 0,
          linkedRiskDelta: 'reduced',
          reason: 'ressource: réserve conservée et signal régional stable',
          waitingAction: 'jouer si utile, sinon garder une veille légère sans relancer le bundle',
        },
        readinessRecap: {
          state: 'ready-now',
          reason: 'ressource: réserve conservée et signal régional stable',
          linkedCooldownState: 'ready-now',
          linkedRiskDelta: 'reduced',
          residualRisk: 'résiduel faible: conserver la réserve et surveiller la saison',
          safeAction: 'différer et garder seulement une veille météo',
          avoidAction: 'éviter de consommer la réserve sur un second bundle immédiat',
          dataConfidence: 'probable',
        },
      },
    ],
  });
    ...
    followUpQueue: [
      {
        ...
        cooldownReadiness: {
          ...
          label: 'bientôt sûr',
          availableInTurns: 1,
          linkedRiskDelta: 'stable-risk',
          reason: 'saison: timing de cooling-off encore actif',
          waitingAction: 'attendre la fin du cooling-off et préserver la readiness locale',
        },
        readinessRecap: {
          state: 'soon-safe',
          reason: 'saison: timing de cooling-off encore actif',
          linkedCooldownState: 'soon-safe',
          linkedRiskDelta: 'stable-risk',
          residualRisk: 'résiduel modéré: cooling-off ou readiness encore à confirmer',
          safeAction: 'attendre la fin du cooling-off et préserver la readiness locale',
          avoidAction: 'éviter de forcer le follow-up avant la fin du cooling-off',

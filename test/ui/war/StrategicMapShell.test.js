  ...
  assert.deepEqual(shell.residualIntrigueCleanupTiming, {
    ...
    lastSafeWindowCue: {
      ...
      atLastSafeTurn: {
        ...
        cue: 'au dernier tour sûr: Dissiper attention résiduelle',
        reliableAction: 'Dissiper attention résiduelle',
        tooExposedAction: null,
        reason: 'fallback encore sûr, mais attendre le fallback perd le meilleur score sûr (50)',
        exposureBudget: 50,
        cutoff: 'avant la prochaine action majeure',
        secondary: true,
      },
  ...
  assert.deepEqual(buildResidualIntrigueCleanupTiming(
    ...
    lastSafeWindowCue: {
      ...
      atLastSafeTurn: {
        ...
        reliableAction: null,
        tooExposedAction: 'recontrôler le risque résiduel avant nouvelle escalade',
        reason: 'attendre force une relecture avant nouvelle escalade',
        exposureBudget: null,
        cutoff: 'au prochain tour/action',
        secondary: true,
      },
  ...
  assert.deepEqual(buildResidualIntrigueCleanupTiming(), {
    ...
    lastSafeWindowCue: {
      ...
      atLastSafeTurn: {
        ...
        reliableAction: null,
        tooExposedAction: null,
        reason: 'budget d’exposition sûr non lisible',
        exposureBudget: null,
        cutoff: null,
        secondary: true,
      },

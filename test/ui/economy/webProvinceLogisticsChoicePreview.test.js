...
test('playable province detail renders compact logistics route causes', () => {
  ...
  assert.match(webAppSource, /province-logistics-spillover-after-delivery-fragility/);
  assert.match(webAppSource, /afterDeliveryFragility/);
  assert.match(webAppSource, /afterDeliveryFragility\.summary/);
  assert.match(webAppSource, /province-logistics-spillover-next-stabilizer/);
  assert.match(webAppSource, /nextStabilizerRecommendation/);
  assert.match(webAppSource, /nextStabilizerRecommendation\.summary/);
  assert.match(webAppSource, /province-logistics-spillover-after-stabilization/);
  assert.match(webAppSource, /afterStabilization/);
  assert.match(webAppSource, /afterStabilization\.summary/);
  assert.match(webAppSource, /province-logistics-spillover-after-second-stabilizer/);
  assert.match(webAppSource, /afterSecondStabilizerDebt/);
  assert.match(webAppSource, /afterSecondStabilizerDebt\.summary/);
  assert.match(webAppSource, /province-logistics-spillover-next-delivery-impact/);
  assert.match(webAppSource, /nextDeliveryDebtImpact/);
  assert.match(webAppSource, /nextDeliveryDebtImpact\.summary/);
